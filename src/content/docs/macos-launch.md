...
В выводе должен быть файл `AutoPilot`, рядом — `BybitAutoPilot.config`, `data/` и другие файлы пилота.
...
Если всё сделано правильно — AutoPilot запустится в окне терминала, прочитает `BybitAutoPilot.config` и начнёт работу.
