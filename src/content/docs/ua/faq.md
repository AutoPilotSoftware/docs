...
> ✅ **Заповнювати не потрібно** — AutoPilot автоматично бере проксі з вашого профілю AdsPower / Dolphin / Vision на льоту. Проксі передається в сервіс вирішення капчі, щоб капча була вирішена з IP профілю. Все відбувається автоматично.
