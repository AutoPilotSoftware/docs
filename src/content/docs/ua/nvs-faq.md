...
Ви купили акаунти в **NVS Shop** і отримали посилання. Нижче — як завантажити акаунти в бот.

---

## Швидкий старт: AdsPower (рекомендовано)
...
> Немає AdsPower? Завантажте проксі і куки окремо.
...
**Крок 2.** Витягніть secure-токен з акаунтів. Відео-інструкція:

[![Відео: витягнення токена](../../../assets/nvs/manual-2.png)](https://www.youtube.com/watch?v=AYrxVrHdroY)

> [Дивитися відео на YouTube](https://www.youtube.com/watch?v=AYrxVrHdroY)
...
| Вставили текст | Вставили куки текстом або JWT-токен | Використовуйте 📎 для надсилання як документа |
...
Експортуйте через розширення **Cookie Editor** або **Edit My Cookie**, або у вашому Anti-Detect браузері натисніть **Експортувати**.

#### Чи можна надіслати куки текстом?

**Ні.** Тільки `.json` файли через 📎.
