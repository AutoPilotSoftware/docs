...
:::caution["Невірне або прострочене посилання"]
Поверніться в NVS Shop і отримайте нове.
:::
...
:::caution
Надсилайте як **документ**, не як фото або текст.
:::
...
:::caution
НЕ вставляйте вміст куки текстом — надсилайте файли через 📎.
:::
