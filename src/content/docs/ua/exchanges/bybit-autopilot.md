...
Швидке HTTP-виведення коштiв без браузера — прямi запити до Bybit API, пiдтвердження email-кодом + 2FA, все автоматично. Замiнило стару браузерну реалiзацiю за замовчуванням (стара лишена як fallback тiльки для `full_withdraw=YES + USDT`).
