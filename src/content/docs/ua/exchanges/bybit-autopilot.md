...
| Мережа | Комiсiя | Мiн. вивiд | Опис |
|--------|---------|------------|------|
| `APTOS` | 0 USDT | 0 | Зараз найдешевша |
| `TRX` | 1 USDT | 2.6 | Старий добрий USDT, приймають майже всюди |
| `BSC` | 0.2 USDT | 10 | Binance Smart Chain, сюди часто шлють |
| `MATIC` | 0.1 USDT | 1 | Polygon, дешево |
| `ARBI` | 0.1 USDT | 1 | Arbitrum, дешево |
| `OP` | 1 USDT | 1 | Optimism |
| `SOL` | 0.5 USDT | 10 | Solana, швидко, але не всi її приймають |
| `ETH` | 0.8 USDT | 6 | Класичний Ethereum, дорого — лише якщо iнакше нiяк |
| `TON` | 0.15 USDT | 1 | Telegram-мережа, без memo не вiдправиться |
