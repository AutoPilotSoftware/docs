...
:::danger[Збережiть секретну фразу!]
Показується один раз. Втратили фразу = втратили доступ до всiх адрес та коштiв.
:::
...
:::note[Можна перезапускати]
Вже є адреса? AutoPilot використає її — дублiкатiв не буде.
:::
...
:::note[Приватнiсть]
Кожен акаунт → своя адреса → спiльних адрес немає → зв'язати акаунти мiж собою неможливо.
:::
