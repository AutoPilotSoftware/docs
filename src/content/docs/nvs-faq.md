...
:::caution[Неверная или просроченная ссылка]
Вернитесь в NVS Shop и получите новую.
:::
...
:::caution
Отправляйте как **документ**, не как фото или текст.
:::
...
:::caution
НЕ вставляйте содержимое куки текстом — отправляйте файлы через 📎.
:::
