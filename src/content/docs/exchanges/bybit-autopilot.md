...
| Сеть | Комиссия | Мин. вывод | Описание |
|------|----------|------------|----------|
| `APTOS` | 0 USDT | 0 | Сейчас самая дешёвая |
| `TRX` | 1 USDT | 2.6 | Старый добрый USDT, принимают почти везде |
| `BSC` | 0.2 USDT | 10 | Binance Smart Chain, сюда часто шлют |
| `MATIC` | 0.1 USDT | 1 | Polygon, дёшево |
| `ARBI` | 0.1 USDT | 1 | Arbitrum, дёшево |
| `OP` | 1 USDT | 1 | Optimism |
| `SOL` | 0.5 USDT | 10 | Solana, быстро, но не все её принимают |
| `ETH` | 0.8 USDT | 6 | Классический Ethereum, дорого — берите только если иначе никак |
| `TON` | 0.15 USDT | 1 | Telegram-сеть, без memo не отправится |
