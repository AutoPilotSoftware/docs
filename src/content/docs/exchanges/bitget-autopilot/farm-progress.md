...
> 🔒 **СОВЕРШЕННО СЕКРЕТНО. Внутренняя страница (в разработке).**
>
> Действие написано, но **ещё ни разу не запускалось на живом аккаунте**. Страница скрыта из меню и из поиска — доступна только по прямой ссылке.
>
> ⛔ **Не пересылайте ссылку и не публикуйте содержимое.** Здесь описан незапущенный внутренний механизм и разобранные внутренние запросы биржи — материал только для своих.
