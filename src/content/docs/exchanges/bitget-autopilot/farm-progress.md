...
Номинал ваучеров — **100–200 USDT** каждый. Это не кэш, а торговая маржа биржи; сколько с неё реально снимается, мы ещё не измеряли.
...
> 📊 **Про доходность.** Пока не пишем цифр. Сколько это реально приносит, посчитаем после первых боевых прогонов — по фактическим выплатам, а не по прикидкам.
