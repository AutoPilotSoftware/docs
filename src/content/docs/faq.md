...
> ✅ **Заполнять не нужно** — AutoPilot автоматически берёт прокси из вашего профиля AdsPower / Dolphin / Vision на лету. Прокси передаётся в сервис решения капчи, чтобы капча была решена с IP профиля. Всё происходит автоматически.
